...
function profile(){
	if($("#SearchAgeMin").val() == null || $("#SearchAgeMin").val() == '') {
		$("input[name=SearchAgeMin]").attr("value", 1);
	}
	if($("#SearchAgeMax").val() == null || $("#SearchAgeMax").val() == '') {
		$("input[name=SearchAgeMax]").attr("value", 150);
	}
}
...
<!-- 검색기능, 쿼리문에 직접적으로 하는것이므로 카멜케이스 사용X  -->
	<div id="search">
